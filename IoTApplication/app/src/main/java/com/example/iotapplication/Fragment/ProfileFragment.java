...
import com.example.iotapplication.LoginActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("sharePref: ", String.valueOf(sharedPreferences.contains(MainActivity.Username)));
                editor.clear();
                editor.apply();
    ...
    public void getAmout(){
        homeSharedPref = context.getSharedPreferences("home", Context.MODE_PRIVATE);
        Integer amount = homeSharedPref.getInt("amount_device",0);


        amountDev = view.findViewById(R.id.amountDev);
        amountDev.setText(String.valueOf(amount));
    }
}